...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PushNotificationApi.InlineResponse2013Response();
  });
  ...
  describe('InlineResponse2013Response', function() {
    it('should create an instance of InlineResponse2013Response', function() {
      // uncomment below and update the code to test InlineResponse2013Response
      //var instane = new PushNotificationApi.InlineResponse2013Response();
      //expect(instance).to.be.a(PushNotificationApi.InlineResponse2013Response);
    });
