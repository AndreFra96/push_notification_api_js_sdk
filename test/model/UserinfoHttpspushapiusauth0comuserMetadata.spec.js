...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PushNotificationApi.UserinfoHttpspushapiusauth0comuserMetadata();
  });
  ...
  describe('UserinfoHttpspushapiusauth0comuserMetadata', function() {
    it('should create an instance of UserinfoHttpspushapiusauth0comuserMetadata', function() {
      // uncomment below and update the code to test UserinfoHttpspushapiusauth0comuserMetadata
      //var instane = new PushNotificationApi.UserinfoHttpspushapiusauth0comuserMetadata();
      //expect(instance).to.be.a(PushNotificationApi.UserinfoHttpspushapiusauth0comuserMetadata);
    });

    it('should have the property firebaseAdminKey (base name: "firebase_admin_key")', function() {
      // uncomment below and update the code to test the property firebaseAdminKey
      //var instane = new PushNotificationApi.UserinfoHttpspushapiusauth0comuserMetadata();
      //expect(instance).to.be();
    });

    it('should have the property sqlDbConfig (base name: "sql_db_config")', function() {
      // uncomment below and update the code to test the property sqlDbConfig
      //var instane = new PushNotificationApi.UserinfoHttpspushapiusauth0comuserMetadata();
      //expect(instance).to.be();
    });
