...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PushNotificationApi.MessagesApi();
  });
  ...
  describe('MessagesApi', function() {
    describe('sendGroupMessage', function() {
      it('should call sendGroupMessage successfully', function(done) {
        //uncomment below and update the code to test sendGroupMessage
        //instance.sendGroupMessage(function(error) {
