...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PushNotificationApi.UserinfoResponse();
  });
  ...
  describe('UserinfoResponse', function() {
    it('should create an instance of UserinfoResponse', function() {
      ...
      //var instane = new PushNotificationApi.UserinfoResponse();
      //expect(instance).to.be.a(PushNotificationApi.UserinfoResponse);
    });
