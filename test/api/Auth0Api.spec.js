...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PushNotificationApi.Auth0Api();
  });
  ...
  describe('Auth0Api', function() {
    ...
    describe('setUserAdminSDK', function() {
      it('should call setUserAdminSDK successfully', function(done) {
        //uncomment below and update the code to test setUserAdminSDK
        //instance.setUserAdminSDK(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('setUserDb', function() {
      it('should call setUserDb successfully', function(done) {
        //uncomment below and update the code to test setUserDb
        //instance.setUserDb(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
