...
/**
* The InlineResponse2013Response model module.
* @module model/InlineResponse2013Response
* @version 1.0.0
*/
export default class InlineResponse2013Response {
    /**
    * Constructs a new <code>InlineResponse2013Response</code>.
    * @alias module:model/InlineResponse2013Response
    * @class
    */
    ...
    /**
    * Constructs a <code>InlineResponse2013Response</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/InlineResponse2013Response} obj Optional instance to populate.
    * @return {module:model/InlineResponse2013Response} The populated <code>InlineResponse2013Response</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new InlineResponse2013Response();
