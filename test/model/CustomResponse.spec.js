...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PushNotificationApi.CustomResponse();
  });
  ...
  describe('CustomResponse', function() {
    it('should create an instance of CustomResponse', function() {
      // uncomment below and update the code to test CustomResponse
      //var instane = new PushNotificationApi.CustomResponse();
      //expect(instance).to.be.a(PushNotificationApi.CustomResponse);
    });

    it('should have the property canonicalRegistrationTokenCount (base name: "canonicalRegistrationTokenCount")', function() {
      // uncomment below and update the code to test the property canonicalRegistrationTokenCount
      //var instane = new PushNotificationApi.CustomResponse();
    ...
    it('should have the property multicastId (base name: "multicastId")', function() {
      // uncomment below and update the code to test the property multicastId
      //var instane = new PushNotificationApi.CustomResponse();
      //expect(instance).to.be();
    });
